package com.szczesniak.dominik.joboffers.feature;

import com.github.tomakehurst.wiremock.client.WireMock;
import com.szczesniak.dominik.joboffers.BaseIntegrationTest;
import com.szczesniak.dominik.joboffers.SampleJobOfferResponse;
...
public class TypicalScenarioUserWantToSeeOffersIntegrationTest extends BaseIntegrationTest implements SampleJobOfferResponse {
	...
	public void user_want_to_see_offers_but_have_to_be_logged_in_and_external_server_should_have_some_offers(){
		...
		// when
		final List<JobOfferResponse> jobOfferResponses = offerHttpClient.fetchOffers();
		System.out.println(jobOfferResponses);
